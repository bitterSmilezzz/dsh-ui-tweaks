 ...
 *        3 个 client factory（model-selector/paste-input/attachment-remove）
 *        已内联为唯一事实来源；独立的 lib/{paste-input,model-selector}/client.js
 *        子文件已删除（2026-08-19 架构级合并——消除双份维护）。
 *        at-file（@文件引用）已移除（2026-08-20：官方 rc.8 @ 菜单支持文件/会话引用，功能重复）。
 *
 ...
 *   fs/webServer/loader/sessions（paste-input）+ webServer/settings（retry 路由）。
 *   model-selector 无 host 依赖。
 */
